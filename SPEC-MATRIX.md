...
screen, and verification-failure reporting. Four 🔴 conformance defects remain recorded and **not yet fixed**
in the [18013-5 table](#isoiec-18013-52021) — per-`DocRequest` reader auth, Annex B EKU, §9.3.3 IACA subject
checks, and §9.3.1 steps 4-5 (`EReaderKeyBytes` re-encoding is now closed). They sit
